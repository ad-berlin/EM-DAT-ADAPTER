...
with st.container(border=True):
    st.write("""
    :violet[Sources of the **Data Quality** page]  
    [1] https://doc.emdat.be/docs/data-structure-and-content/emdat-public-table/  
    [2] https://doc.emdat.be/docs/data-structure-and-content/impact-variables/human/
    """)
