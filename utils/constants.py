...
# lists of constants
original_list = [
    NUM, DIS_NAT_TECH, DIS_SUBGROUP, DIS_TYPE, DIS_SUBTYPE, COUNTRY, REGION, SUBREGION, LOCATION, ORIGIN,
...
info_list = [
    ORIGIN_CLEAN, ASS_TYPES, REGION, SUBREGION, LOCATION, RIVER, MONTH_START, CONTINENT_R, SUBREGION,
    UN_M49_IR, NAME
]

att_list = [
    DIS_SUBGROUP, DIS_TYPE, DIS_SUBTYPE, CLASS_KEY
]
...
regions_list = [
    COUNTRY, REGION, SUBREGION, CONTINENT_R, M49_CODE_R, GEOGRAPH_SR, M49_CODE_SR, UN_M49_IR, M49_CODE_IR,
